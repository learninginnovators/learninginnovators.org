---
title: Assigning Students to TAs for Feedback
description: Setting up the student-mentor relationship
---
...
![task details](./images/NavigateToTutorials.png)
...
![task details](./images/AddNewStream.png)
...
![task details](./images/AddExtraFeedbackStream.png)

3. Navigate to the Students tab of the Admin panel.

![task details](./images/NavigateToStudents.png)
