---
title: Moderation System & Escalations
description: The moderation panel helps Conveners monitor feedback consistency and manage student appeals.
...
![task details](./images/NavigateToModeration.png)
...
![task details](./images/StudentFeedbackReview.png)

2. Review the feedback. To agree with the TA click Upheld. To agree with the student, click Overturn.

![task details](./images/Upheld.png) ![task details](./images/Overturn.png)
