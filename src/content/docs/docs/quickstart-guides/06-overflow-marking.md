---
title: Overflow Marking System
description: When staff members fall behind or go on leave, overdue tasks automatically transition to the shared Overflow Queue.
...
![task details](./images/NavigateToOverflow.png)


1. Select a task from the shared queue and click Claim Task.

![task details](./images/ClaimOverflowTask.png)

3. The task is locked to that TA for 30 minutes.
